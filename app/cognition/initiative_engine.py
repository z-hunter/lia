...
from app.safety.rate_limits import ProactiveRateLimiter
class InitiativeEngine:
    def __init__(self, repo:MemoryRepository): self.repo=repo; self.rate_limiter=ProactiveRateLimiter(repo)
    ...
    def run_once(self)->str|None:
        if not settings.proactive_messages_enabled or self._quiet() or not self.rate_limiter.allowed(): return None
